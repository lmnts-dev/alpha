...
const GlobalClasses = createGlobalStyle`
  ...
  /* _______________________________________________________*/
  /** Full width sections & grid breakers. **/
  .__fullwidth {
    margin-left: calc(${Root.Grid.Gutter.Left} * -1);
    margin-right: calc(${Root.Grid.Gutter.Right} * -1);
    padding-left: calc(${Root.Grid.Gutter.Left} * 1);
    padding-right: calc(${Root.Grid.Gutter.Right} * 1);
    width: calc(100% + (${Root.Grid.Gutter.Left} + ${Root.Grid.Gutter.Right}));
    max-width: 100vw;
  }

  /* _______________________________________________________*/
  /** For scaffolding sections. **/
  .__scaffold {
    ...
    font-weight: 500;
    font-family: ${Theme.Font.Header};
    border-top: 1px solid ${hexToRGB(Theme.Color.Black, 0.04)};
    border-bottom: 1px solid ${hexToRGB(Theme.Color.Black, 0.04)};
